                       ...
                       <div class="layout_padding">
                          ...
                          <c:forEach items="${results}" var="element"> 
                            <tr>
                              ...
                              <td>${element.userid}</td>
                              <td>${element.glucose}</td>
                              <td>${element.pregnancies}</td>
                              <td>${element.skin_thickness}</td>
                              <td>${element.insulin}</td>
                              <td>${element.diabetes_pedigree}</td>
                              <td>${element.age}</td>
                              <td>${element.result}</td>
                              <td>
                                <form action="checkResult" method="get">
                                 <input type="hidden" value="${element.id}" name="uid"/>
                                 <input type="submit" value="checkResult" class="btn btn-success">
                               </form>
                               </td>
